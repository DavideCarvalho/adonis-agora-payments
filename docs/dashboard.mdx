...
`billing_payments` is a single mutable row upserted in place. What it used to be is recorded
...
Three kinds of row, each of which used to be a diagnostic and nothing else:
