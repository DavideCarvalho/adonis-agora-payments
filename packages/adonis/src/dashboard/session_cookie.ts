 ...
 * AdonisJS types) — ported verbatim from `@adonis-agora/durable`'s `src/dashboard/session_cookie.ts` so the
 * cookie format is identical across every Agora console and this stays
